...
public class RoomTypeController {
    ...
    public String roomTypeList(MultipartFile attach){
        ...
        if (!attach.isEmpty()) {
            //获取文件上传地址
            String path = "D:/ADAI/boottest/ssm-hotel-parent/ssm-hotel-manager/src/main/webapp/upload/roomType-pic/main/";
            //获取源文件名称
            ...
            try {
                ...
                dataMap.put("src","/upload/roomType-pic/main/"+finalName);//文件上传成功的回显地址
