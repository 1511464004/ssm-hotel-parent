...
<script>
    layui.use(["layer", "table", "form", "jquery","laydate","upload","layedit"], function () {
        ...
        function openUpdateWindow(data) {
            mainIndex = layer.open({
                ...
                success: function () {
                    ...
                    //图片回显
                    $(".thumbImg").attr("src","/upload/room-pic/main/"+data.photo);
                }
            });
        }
        ...
        function deleteById(data) {
            ...
            if (data.status != 1) {//1为可预订
                ...
                //提示用户是否确认删除
                layer.confirm("确认要删除 [<font color='#FE784D'>" + data.title + "(" + data.roomNum + ")" + "</font>] 房间么？", {
                    icon: 3,
                    title: "提示"
                }, function (index) {
                    //发送删除的请求
